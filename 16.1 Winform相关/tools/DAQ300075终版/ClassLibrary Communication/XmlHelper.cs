...
namespace ClassLibrary_Communication
{
    public class XmlHelper
    {
        ...
        /// <returns></returns>
        public bool CreateXmlDocument(string RootName,string DirPath,string Note)
        {
            try
            {
                xDocument = new XDocument(
                    new XElement(RootName, new XAttribute("ProjectName", RootName), new XAttribute("Note", Note),
